  ...
  items={[
    {
      ...
      description:
        'Successfully launched FaceBits v1 with core face registration/recognition API, WebUI SDK, iframe integration, and basic dashboard',
      date: 'Q2 2025',
      status: 'completed',
    ...
    },
    {
      ...
      description:
        'Add comprehensive billing system, usage insights, and analytics to the admin dashboard',
      date: 'Q4 2025',
      status: 'future',
      category: 'Feature',
    },
    {
      ...
      description:
        'Implement scoped access controls, usage limits, and advanced API key management',
      date: 'Q4 2025',
      status: 'future',
      category: 'Security',
    },
    {
      ...
      description:
        'Build comprehensive React SDK and support libraries for seamless integration',
      date: 'Q1 2026',
      status: 'future',
      category: 'SDK',
    },
    {
      ...
      description:
        'Enable custom payload configuration and advanced webhook management for system integration',
      date: 'Q1 2026',
      status: 'future',
    ...
    },
    {
      ...
      description:
        'Optimize recognition speed, reduce latency, and improve overall system performance',
      date: 'Q1 2026',
      status: 'future',
    ...
    },
    {
      ...
      description:
        'Launch FaceBits v2.0 with all major features, custom ML models, and enterprise capabilities',
      date: 'Feb 2026',
      status: 'future',
      category: 'Major Release',
    },
